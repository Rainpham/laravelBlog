...
<section id="section-category">
    ...
    <div class="title-section" style="line-height: 40px;"><b><span style="color: #000"></span> {{$newsBySlug->title}}</b></div>
    <div class="content">
        <p style="text-align:center"><strong></p>

<p style="text-align:justify">{{$newsBySlug->description}}</p>

<p>&nbsp;</p>

<p style="text-align:justify">{{$newsBySlug->content}}</p>
